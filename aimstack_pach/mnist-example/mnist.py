...
pipeline_name = os.getenv("PPS_PIPELINE_NAME", "Local")
job_id = os.getenv("PACH_JOB_ID", "")
repo = os.getenv("AIM_ENDPOINT", "")
# Initialize a new Run with remote tracking URL
aim_run = Run(experiment=pipeline_name,run_hash=job_id,repo=repo)  # replace example IP with your tracking server IP/hostname
